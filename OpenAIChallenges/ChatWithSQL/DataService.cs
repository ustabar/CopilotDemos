/* 
create a cs class with namespace as YourOwnData
it should use SqlClient and JavaScriot JSType
it should have a method GetDataTable that takes 
a string query and returns a List of List of string
*/
using System;
